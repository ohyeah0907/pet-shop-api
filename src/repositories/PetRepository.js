    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma_1.default.pet.findMany({
                        include: {
                            type: true,
                        },
...
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.pet.findUnique({
                    include: {
                        type: true,
                    },
                    where: {
...
var save = function (pet) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!pet.id) return [3 /*break*/, 2];
                return [4 /*yield*/, prisma_1.default.pet.update({
                        where: {
                            id: pet.id,
                        },
                        data: {
            ...
            case 2: return [4 /*yield*/, prisma_1.default.pet.create({
                    data: {
                        name: pet.name,
                        sku: pet.sku,
                        age: pet.age,
