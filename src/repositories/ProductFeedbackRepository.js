...
var findAll = function (search, include) { return __awaiter(void 0, void 0, void 0, function () {
    var condition, productFeedbacks;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                condition = {};
                if (search === null || search === void 0 ? void 0 : search.user) {
                    condition.user_id = search.user.id;
                }
                if (search === null || search === void 0 ? void 0 : search.pet) {
                    condition.pet_id = search.pet.id;
                }
                if (search === null || search === void 0 ? void 0 : search.accessory) {
                ...
                return [4 /*yield*/, prisma_1.default.productFeedback.findMany({
                        where: __assign({ state: client_1.ObjectState.ACTIVE }, condition),
                        include: __assign({ user: true, pet: true, accessory: true }, (include || {})),
                    })];
            case 1:
                productFeedbacks = _a.sent();
                return [2 /*return*/, productFeedbacks];
        }
    });
}); };
var findById = function (id, include) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.productFeedback.findUnique({
                    include: __assign({ user: true, pet: true, accessory: true }, (include || {})),
                    where: {
                        id: id,
...
var save = function (productFeedback, include) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!productFeedback.id) return [3 /*break*/, 2];
                return [4 /*yield*/, prisma_1.default.productFeedback.update({
                        where: {
            ...
            case 2: return [4 /*yield*/, prisma_1.default.productFeedback.create({
                    data: {
                        user: {
