    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (search === null || search === void 0 ? void 0 : search.parent) {
                ...
                return [4 /*yield*/, prisma_1.default.accessoryType.findMany({
                        where: __assign({ state: client_1.ObjectState.ACTIVE }, condition),
                        include: __assign({ accessories: true, parent: true, children: true }, (include || {})),
                    })];
            case 1:
                accessoryTypes = _a.sent();
                return [2 /*return*/, accessoryTypes];
        }
    });
}); };
var findById = function (id, include) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.accessoryType.findUnique({
            ...
            case 1:
                ...
                return [2 /*return*/, accessoryType];
        }
    });
}); };
var save = function (accessoryType, include) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!accessoryType.id) return [3 /*break*/, 2];
                return [4 /*yield*/, prisma_1.default.accessoryType.update({
                        where: {
                            id: accessoryType.id,
                        },
                        data: {
            ...
            case 2: return [4 /*yield*/, prisma_1.default.accessoryType.create({
                    data: {
                        name: accessoryType.name,
                        state: accessoryType.state,
                        parent: accessoryType.parent_id
