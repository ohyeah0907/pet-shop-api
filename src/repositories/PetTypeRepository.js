    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma_1.default.petType.findMany({
                        include: {
                            pets: true,
                            parent: true,
                            children: true,
...
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.petType.findUnique({
                    include: {
                        pets: true,
                        parent: true,
                        children: true,
            ...
            case 1:
                petType = _a.sent();
                return [2 /*return*/, petType];
        }
    });
}); };
var save = function (petType) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!petType.id) return [3 /*break*/, 2];
                return [4 /*yield*/, prisma_1.default.petType.update({
                        where: {
                            id: petType.id,
                        },
                        data: {
            ...
            case 2: return [4 /*yield*/, prisma_1.default.petType.create({
                    data: {
                        name: petType.name,
                        state: petType.state,
                        parent: petType.parent_id
