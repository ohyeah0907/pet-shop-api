    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma_1.default.promotion.findMany({
...
var findById = function (id, include) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.promotion.findUnique({
                    include: __assign({}, (include || {})),
                    where: {
                        id: id,
...
var save = function (promotion, include) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!promotion.id) return [3 /*break*/, 2];
                return [4 /*yield*/, prisma_1.default.promotion.update({
                        where: {
                            id: promotion.id,
                        },
                        data: {
            ...
            case 2: return [4 /*yield*/, prisma_1.default.promotion.create({
                    data: {
                        name: promotion.name,
                        description: promotion.description,
                        start_date: promotion.start_date,
