    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma_1.default.accessory.findMany({
                        where: __assign({ state: client_1.ObjectState.ACTIVE }, condition),
                        include: __assign({ type: true }, (include || {})),
                    })];
            case 1:
                accessories = _a.sent();
...
var findById = function (id, include) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.accessory.findUnique({
                    include: __assign({ type: true }, (include || {})),
                    where: {
                        id: id,
...
var save = function (accessory, include) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!accessory.id) return [3 /*break*/, 2];
                return [4 /*yield*/, prisma_1.default.accessory.update({
                        where: {
                            id: accessory.id,
                        },
                        data: {
            ...
            case 2: return [4 /*yield*/, prisma_1.default.accessory.create({
                    data: {
                        name: accessory.name,
                        sku: accessory.sku,
                        price: accessory.price,
