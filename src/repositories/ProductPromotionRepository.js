...
var findAll = function (search, include) { return __awaiter(void 0, void 0, void 0, function () {
    var condition, productPromotions;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma_1.default.productPromotion.findMany({
                        where: __assign({ state: client_1.ObjectState.ACTIVE }, condition),
                        include: __assign({ pet: true, accessory: true, promotion: true }, (include || {})),
                    })];
            case 1:
                productPromotions = _a.sent();
                return [2 /*return*/, productPromotions];
        }
    });
}); };
var findById = function (id, include) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.productPromotion.findUnique({
...
var save = function (productPromotion, include) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!productPromotion.id) return [3 /*break*/, 2];
                return [4 /*yield*/, prisma_1.default.productPromotion.update({
                        where: {
            ...
            case 2: return [4 /*yield*/, prisma_1.default.productPromotion.create({
                    data: {
                        pet: {
