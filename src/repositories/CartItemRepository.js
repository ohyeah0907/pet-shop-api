...
var findAll = function (search, include) { return __awaiter(void 0, void 0, void 0, function () {
    var condition, cartItems;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                condition = {};
                if (search === null || search === void 0 ? void 0 : search.cart) {
                ...
                return [4 /*yield*/, prisma_1.default.cartItem.findMany({
                        where: __assign({ state: client_1.ObjectState.ACTIVE }, condition),
                        include: __assign({ cart: {
                                include: {
                                    user: {
                                        select: {
                                            name: true,
                            ...
                            }, pet: { select: { name: true } }, accessory: { select: { name: true } } }, (include || {})),
                    })];
            case 1:
                cartItems = _a.sent();
...
var findById = function (id, include) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_1.default.cartItem.findUnique({
...
var save = function (cartItem, include) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!cartItem.id) return [3 /*break*/, 2];
                return [4 /*yield*/, prisma_1.default.cartItem.update({
                        where: {
                            id: cartItem.id,
                        },
                        data: {
            ...
            case 2: return [4 /*yield*/, prisma_1.default.cartItem.create({
                    data: {
                        cart: {
                            connect: { id: cartItem.cart_id },
                        },
