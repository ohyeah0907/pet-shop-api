...
var PromotionRepository_1 = require("../repositories/PromotionRepository");
var service = {
    getSearch: function (search, include) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, PromotionRepository_1.default.findAll(search, include)];
        });
    }); },
    getById: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, PromotionRepository_1.default.findById(id)];
                case 1:
                    promotion = _a.sent();
                    if (!promotion)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, PromotionRepository_1.default.save(promotion)];
                case 1:
                    created = _a.sent();
    ...
    delete: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    promotion = _a.sent();
                    promotion.state = client_1.ObjectState.DELETED;
