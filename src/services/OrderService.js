...
var service = {
    getSearch: function (search, include) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, OrderRepository_1.default.findAll(search, include)];
        });
    }); },
    getById: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, OrderRepository_1.default.findById(id)];
                case 1:
                    order = _a.sent();
                    if (!order)
    ...
    create: function (create) { return __awaiter(void 0, void 0, void 0, function () {
        var user, order, created;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, UserService_1.default.getUserById((_a = create.user) === null || _a === void 0 ? void 0 : _a.id)];
                case 1:
                    user = _b.sent();
                    order = {
                        id: 0,
                    ...
                    return [4 /*yield*/, OrderRepository_1.default.save(order)];
                case 2:
                    created = _b.sent();
    ...
    delete: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    order = _a.sent();
                    order.state = client_1.ObjectState.DELETED;
