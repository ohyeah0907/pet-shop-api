...
var CartRepository_1 = require("../repositories/CartRepository");
var UserService_1 = require("./UserService");
var service = {
    getSearch: function (search, include) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, CartRepository_1.default.findAll(search, include)];
        });
    }); },
    getById: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, CartRepository_1.default.findById(id)];
                case 1:
                    cart = _a.sent();
                    if (!cart)
                        throw new Error("Không tìm thấy cart");
                    return [2 /*return*/, cart];
            }
        });
    }); },
    create: function (create) { return __awaiter(void 0, void 0, void 0, function () {
        var user, cart, created;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, UserService_1.default.getUserById(create.user.id)];
                case 1:
                    user = _a.sent();
                    cart = {
                        id: 0,
                    ...
                    return [4 /*yield*/, CartRepository_1.default.save(cart)];
                case 2:
                    created = _a.sent();
    ...
    delete: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    cart = _a.sent();
                    cart.state = client_1.ObjectState.DELETED;
