...
var AccessoryRepository_1 = require("../repositories/AccessoryRepository");
...
var service = {
    getSearch: function (search, include) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, AccessoryRepository_1.default.findAll(search, include)];
        });
    }); },
    getById: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, AccessoryRepository_1.default.findById(id)];
                case 1:
                    accessory = _a.sent();
                    if (!accessory)
    ...
    create: function (create) { return __awaiter(void 0, void 0, void 0, function () {
        var type, accessory, created;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, AccessoryTypeService_1.default.getById(create.type.id)];
                case 1:
                    type = _a.sent();
                    accessory = {
                        id: 0,
                    ...
                    return [4 /*yield*/, AccessoryRepository_1.default.save(accessory)];
                case 2:
                    created = _a.sent();
    ...
    update: function (update) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    accessory = _a.sent();
                    return [4 /*yield*/, AccessoryTypeService_1.default.getById(update.type.id)];
                case 2:
                    type = _a.sent();
