...
exports.default = router.use((0, validator_1.default)(auth_1.default.auth, validator_1.ValidationSource.HEADER), (0, asyncHandler_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                error_1 = _a.sent();
                if (!(error_1 instanceof app_error_1.TokenExpired)) return [3 /*break*/, 7];
            ...
            case 8: return [2 /*return*/, new app_response_1.BadRequestResponse("Token còn sử dụng được").send(res)];
            case 9:
                e_1 = _a.sent();
